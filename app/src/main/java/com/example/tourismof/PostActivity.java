                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        PostsRef.child(current_user_id + postRandomName).child("postimage").setValue(String.valueOf(uri)).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(PostActivity.this, "Fragment_post Added Successfully", Toast.LENGTH_SHORT).show();
        ...
        UsersRef.child(current_user_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    Toast.makeText(PostActivity.this, "New Fragment_post is updated successfully.", Toast.LENGTH_SHORT).show();
